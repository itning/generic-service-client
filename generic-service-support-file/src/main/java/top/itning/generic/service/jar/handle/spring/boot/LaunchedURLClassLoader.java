...
package top.itning.generic.service.jar.handle.spring.boot;
...
import top.itning.generic.service.jar.handle.spring.boot.archive.Archive;
import top.itning.generic.service.jar.handle.spring.boot.jar.Handler;
...
public class LaunchedURLClassLoader extends URLClassLoader {
	...
	protected Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
		if (name.startsWith("top.itning.test.jar.handle.spring.boot.jarmode.")) {
			try {
	...
	private void clearCache(URLConnection connection) throws IOException {
		...
		if (jarFile instanceof top.itning.generic.service.jar.handle.spring.boot.jar.JarFile) {
			((top.itning.generic.service.jar.handle.spring.boot.jar.JarFile) jarFile).clearCache();
		}
	}
