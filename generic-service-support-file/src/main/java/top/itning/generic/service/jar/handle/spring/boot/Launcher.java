...
import top.itning.generic.service.jar.handle.spring.boot.archive.ExplodedArchive;
import top.itning.generic.service.jar.handle.spring.boot.archive.JarFileArchive;
import top.itning.generic.service.jar.handle.spring.boot.jar.JarFile;
...
public abstract class Launcher {
	...
	private static final String JAR_MODE_LAUNCHER = "top.itning.test.jar.handle.spring.boot.jarmode.JarModeLauncher";
